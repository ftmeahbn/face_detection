...
# read pre-trained Caffe models for age and gender
...
def read_from_camera(age_net, gender_net):
	...
	while True:
                ...
                #Capture the frame from the camera and convert it to grayscale
		ret, image = cap.read()
		...
		#If the 'q' key is pressed, break the loop and stop the program
